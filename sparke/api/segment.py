...
from sparke.ingest.impl.utils import create_topic_name
from sparke.segment import SegmentManager, MetadataReader, VectorReader
# from sparke.telemetry import Telemetry
from sparke.ingest import Producer
from sparke.api.models.Collection import Collection
from sparke import __version__
from sparke.errors import InvalidDimensionException, InvalidCollectionException
import sparke.tools.embedding_functions as ef
...
# from sparke.telemetry.events import (
#     CollectionAddEvent,
...
class SegmentAPI(API):
    ...
    def create_collection(
        ...
        embedding_function: Optional[EmbeddingFunction] = ef.OpenAIEmbeddingFunction(),
