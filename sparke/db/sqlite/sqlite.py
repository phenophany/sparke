from sparke.db.sqlite.sqlite_pool import Connection, LockPool, PerThreadPool, Pool
from sparke.db.migrations import MigratableDB, Migration
from sparke.config import System, Settings
import sparke.db.base as base
from sparke.db.works.embeddings_queue import SqlEmbeddingsQueue
from sparke.db.works.sysdb import SqlSysDB
# from sparke.utils.delete_file import delete_file
import sqlite3
...
class SqliteDB(MigratableDB, SqlEmbeddingsQueue, SqlSysDB):
    ...
    def __init__(self, system: System):
        ...
        self._migration_imports = [
            files("sparke.migrations.embeddings_queue"),
            files("sparke.migrations.sysdb"),
            files("sparke.migrations.metadb"),
        ]
        ...
        if not self._is_persistent:
            ...
            self._db_file = (
                self._settings.require("persist_directory") + "/sparke.sqlite3"
            )
