...
from sparke.config import System, get_class
from sparke.db.system import SysDB
from overrides import override
from enum import Enum
from sparke.segment.impl.vector.local_persistent_hnsw import (
    PersistentLocalHnswSegment,
)
from sparke.types import Collection, Operation, Segment, SegmentScope, Metadata
from typing import Dict, Type, Sequence, Optional, cast
from uuid import UUID, uuid4
from collections import defaultdict
import platform

from sparke.tools.lru_cache import LRUCache
...
SEGMENT_TYPE_IMPLS = {
    SegmentType.SQLITE: "sparke.segment.impl.metadata.sqlite.SqliteMetadataSegment",
    SegmentType.HNSW_LOCAL_MEMORY: "sparke.segment.impl.vector.local_hnsw.LocalHnswSegment",
    SegmentType.HNSW_LOCAL_PERSISTED: "sparke.segment.impl.vector.local_persistent_hnsw.PersistentLocalHnswSegment",
}
